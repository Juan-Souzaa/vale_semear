...
<body>
    ...
    <h2 style="color: #1f2937; font-size: 16px; margin-top: 20px;">Detalhes das Reuniões</h2>
    <table>
        <thead>
            <tr>
    ...
    @else
    <p style="text-align: center; color: #6b7280; margin-top: 30px;">Nenhuma reunião encontrada no período selecionado.</p>
    @endif
